...
pub mod load_platforms_reducer;
pub mod monster_table;
pub mod monster_type;
pub mod platform_data_type;
...
pub mod player_type;
pub mod update_physics_reducer;
...
pub use load_platforms_reducer::{
    load_platforms, set_flags_for_load_platforms, LoadPlatformsCallbackId,
};
pub use monster_table::*;
pub use monster_type::Monster;
pub use platform_data_type::PlatformData;
...
pub use update_physics_reducer::{
    set_flags_for_update_physics, update_physics, UpdatePhysicsCallbackId,
};
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            ...
            Reducer::LoadPlatforms { .. } => "load_platforms",
            Reducer::UpdatePhysics => "update_physics",
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            ...
            "load_platforms" => Ok(__sdk::parse_reducer_args::<
                load_platforms_reducer::LoadPlatformsArgs,
            >("load_platforms", &value.args)?
            .into()),
            "update_physics" => Ok(__sdk::parse_reducer_args::<
                update_physics_reducer::UpdatePhysicsArgs,
            >("update_physics", &value.args)?
            .into()),
...
pub struct DbUpdate {
    ...
    monster: __sdk::TableUpdate<Monster>,
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                ...
                "monster" => db_update
                    .monster
                    .append(monster_table::parse_table_update(table_update)?),
                "platform" => db_update
                    .platform
                    .append(platform_table::parse_table_update(table_update)?),
                "player" => db_update
                    .player
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.monster = cache
            .apply_diff_to_table::<Monster>("monster", &self.monster)
            .with_updates_by_pk(|row| &row.id);
        diff.platform = cache
...
pub struct AppliedDiff<'r> {
    ...
    monster: __sdk::TableAppliedDiff<'r, Monster>,
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<Monster>("monster", &self.monster, event);
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        ...
        monster_table::register_table(client_cache);
