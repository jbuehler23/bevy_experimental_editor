...
pub trait update_player_input {
    ...
    fn update_player_input(&self, move_x: f32, jump: bool, attack: bool) -> __sdk::Result<()>;
    ...
    fn on_update_player_input(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &f32, &bool, &bool) + Send + 'static,
...
impl update_player_input for super::RemoteReducers {
    ...
    fn on_update_player_input(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &f32, &bool, &bool) + Send + 'static,
    ) -> UpdatePlayerInputCallbackId {
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                let super::ReducerEventContext {
                    event:
                        __sdk::ReducerEvent {
                            reducer:
                                super::Reducer::UpdatePlayerInput {
                                    move_x,
                                    jump,
                                    attack,
                                },
                ...
                callback(ctx, move_x, jump, attack)
            }),
        ))
    }
    fn remove_on_update_player_input(&self, callback: UpdatePlayerInputCallbackId) {
