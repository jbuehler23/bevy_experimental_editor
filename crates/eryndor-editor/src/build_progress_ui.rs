...
use crate::project_manager::{ProjectSelection, ProjectSelectionState, BuildProgress};

/// System to render build progress overlay
pub fn build_progress_overlay_ui(
    mut contexts: EguiContexts,
    selection: Res<ProjectSelection>,
) {
...
fn render_template_generation(ui: &mut egui::Ui) {
    ui.heading(
        egui::RichText::new("🛠 Generating Project Template")
            .size(24.0)
...
fn render_build_progress(ui: &mut egui::Ui, progress: &BuildProgress) {
    // Title
    ui.heading(
        egui::RichText::new("⚙ Building Project Dependencies")
            .size(24.0)
            .color(egui::Color32::WHITE)
    );
    ...
    egui::Frame::none()
        ...
        .show(ui, |ui| {
            ...
            ui.label(
                egui::RichText::new("💡 Why does this take so long?")
                    .color(egui::Color32::from_rgb(100, 150, 255))
                    .size(13.0)
            );
            ui.add_space(5.0);
            ui.label(
                egui::RichText::new("The first build compiles all Bevy dependencies (graphics, physics, audio). \
