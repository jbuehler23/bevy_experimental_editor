...
linker = "rust-lld.exe"
# Nightly-only flags such as `-Zshare-generics` are intentionally omitted for
# compatibility with the stable toolchain. Uncomment the line below if you use
# nightly and want to enable them.
